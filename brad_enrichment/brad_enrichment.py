...
def cli(gene_string, databases, threshold_p_value, minimum_enrichment_terms, maximum_enrichment_terms, 
    ...
    """
    click.echo("BRAD Enrichment CLI is working!")
    print("Running brad_enrichment.py cli method")
    print(f"{gene_string=}")
    print(f"{databases=}")
    print(f"{threshold_p_value=}")
    print(f"{minimum_enrichment_terms=}")
    print(f"{maximum_enrichment_terms=}")
    print(f"{literature_database=}")
    print(f"{query=}")
    print(f"{output_file=}")
    print(f"{verbose=}")
